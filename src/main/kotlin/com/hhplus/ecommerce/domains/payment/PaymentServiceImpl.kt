...
import com.hhplus.ecommerce.domains.coupon.CouponRepository
import com.hhplus.ecommerce.domains.coupon.CouponStatus
import com.hhplus.ecommerce.domains.order.OrderRepository
import com.hhplus.ecommerce.domains.order.dto.OrderStatus
import com.hhplus.ecommerce.domains.payment.dto.*
import com.hhplus.ecommerce.domains.product.ProductRepository
import com.hhplus.ecommerce.domains.user.UserRepository
...
class PaymentServiceImpl(
    ...
    override fun getOrderPayment(orderId: Long, userId: Long): OrderPaymentResponse {
        ...
        return OrderPaymentResponse(
            ...
            orderNumber = order.orderNumber,
            payment = payment?.let {
                com.hhplus.ecommerce.domains.payment.dto.PaymentInfo(
     ...
     */
    private fun handlePaymentFailure(order: com.hhplus.ecommerce.domains.order.dto.Order) {
        // 1. 재고 복원
